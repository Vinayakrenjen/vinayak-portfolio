            ...
            >
              ...
              <div className="flex justify-between items-center mb-8 relative z-10 border-b border-slate-200 dark:border-slate-700 pb-6">
                ...
                <div className="flex gap-4">
                  <a href={project.github} className="w-10 h-10 rounded-full bg-white dark:bg-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-300 hover:text-lvlBrand dark:hover:text-lvlCyan transition-colors shadow-sm hover:shadow-md">

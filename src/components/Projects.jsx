...
const projectsList = [
  ...
  },
  {
    ...
    live: 'https://opticloud-2lwti3x4wlbwfqu4wgph4e.streamlit.app/',
  }
];
              ...
              <div className="flex justify-between items-center mb-8 relative z-10 border-b border-slate-200 dark:border-slate-700 pb-6">
                ...
                <div className="flex gap-3">
                  ...
                  {project.live && project.live !== '#' && (
                    <a href={project.live} target="_blank" rel="noreferrer" className="px-4 h-10 rounded-full bg-lvlPurple/10 hover:bg-lvlPurple dark:bg-lvlPurple/20 dark:hover:bg-lvlPurple text-lvlPurple hover:text-white dark:text-purple-300 dark:hover:text-white flex items-center justify-center gap-2 font-bold text-xs uppercase tracking-widest transition-all shadow-sm" onClick={(e) => e.stopPropagation()}>
                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg> Live
                    </a>
                  )}
